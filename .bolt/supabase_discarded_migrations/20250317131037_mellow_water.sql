/*
  ...
  1. Changes
    ...
    - Add new function to handle position updates safely
    - Add proper position validation
    - Fix position conflicts during moves
...
DECLARE
  ...
  v_temp_position integer := -999999; -- Use a very low number as temporary position
BEGIN
