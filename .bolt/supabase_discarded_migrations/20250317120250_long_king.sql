/*
  # Fix note movement to handle up/down consistently
  
  1. Changes
    - Simplify position swapping logic
    - Handle up/down movements identically
    - Remove complex position calculations
    - Maintain proper ordering
    
  2. Details
    - Uses direct position swaps
    - Validates positions before moving
    - Updates timestamps properly
*/

-- Function to move notes with consistent up/down handling
