/*
  # Fix note loading and sequence handling

  1. Changes
    - Drop existing move_note function
    - Create improved move_note function with proper sequence handling
    - Add function to normalize sequences
    - Fix sequence relationship constraints

  2. Details
    - Ensures proper sequence handling
