/*
  # Fix note movement transaction handling

  1. Changes
    - Rewrite move_note function with proper transaction boundaries
    - Add explicit locking to prevent concurrent modifications
    - Fix sequence handling during moves
...
-- Create improved move_note function with proper transaction handling
