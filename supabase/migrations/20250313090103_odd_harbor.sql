/*
  # Fix move_note function transaction handling

  1. Changes
    - Rewrite move_note function to handle transactions properly
    - Fix sequence handling during moves
    - Add better error handling and recovery
    - Remove explicit transaction control that was causing issues

  2. Details
    - Uses simpler approach without explicit transaction boundaries
