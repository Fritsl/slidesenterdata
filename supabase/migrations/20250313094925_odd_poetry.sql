/*
  ...
  1. Changes
    - Remove all parent-child relationship columns and constraints
    - Add proper indexes for flat note structure
    - Remove any remaining references to hierarchical structure

  2. Details
    - Ensures notes table works with flat structure
    - Maintains proper indexes for querying
